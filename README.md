# nvim-treesitter-queries-enforce

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-enforce/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-enforce/actions/workflows/validate.yml)

Neovim tree-sitter queries for **enforce**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-enforce",
...
- [ ] Changes are scoped to `enforce` — do not include files for other languages
